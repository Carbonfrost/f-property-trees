...
namespace Carbonfrost.Commons.PropertyTrees.ValueSerializers {
    ...
    sealed class PercentageValueSerializer : ValueSerializer {
        ...
        static object ConvertCore(Type type, string text) {
            ...
            if (text.EndsWith("%", StringComparison.Ordinal)) {
                ...
                percent = true;
            } else if (text.EndsWith("pc", StringComparison.OrdinalIgnoreCase)) {
