...
namespace Carbonfrost.Commons.PropertyTrees.Schema {
    ...
    abstract class ReflectedPropertyTreeFactoryDefinition : OperatorDefinition {
        ...
        sealed class ApplyPropertiesMethod : ReflectedPropertyTreeFactoryDefinition {
            ...
            public override object Apply(object component, object parent, IReadOnlyDictionary<string, object> parameters) {
                return ((IApplyProperties) parent).Apply(
                    parent,
                    QualifiedName,
                    Properties.ReadOnly(parameters));
            }
        }
