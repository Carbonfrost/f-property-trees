...
namespace Carbonfrost.Commons.PropertyTrees.Serialization {
    ...
    interface IPropertyTreeBinderErrors {
        ...
        void BindUnmatchedProperty(QualifiedName qualifiedName, Type componentType, FileLocation loc);
        void BinderConversionError(string name, Type componentType, Exception ex, FileLocation loc);
        ...
        void DuplicatePropertyName(IEnumerable<QualifiedName> duplicates,
                                   FileLocation loc);
        void IdCannotBeBlank(FileLocation loc);
        void IdAlreadyRegistered(string id, FileLocation loc);
