...
namespace Carbonfrost.Commons.PropertyTrees {
    ...
    public class ValueSerializerAttribute : AdapterAttribute {
        ...
        public ValueSerializerAttribute(string valueSerializerType) : base(valueSerializerType) {}
        public ValueSerializerAttribute(Type valueSerializerType) : base(valueSerializerType) {}
    }
}
