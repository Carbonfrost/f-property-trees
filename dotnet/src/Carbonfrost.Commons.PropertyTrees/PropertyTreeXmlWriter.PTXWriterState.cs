...
namespace Carbonfrost.Commons.PropertyTrees {
    ...
    partial class PropertyTreeXmlWriter {
        ...
        class PropertyState : PTXWriterState {
            ...
            private readonly Dictionary<QualifiedName, object> pendingMetadata = new Dictionary<QualifiedName, object>();
            ...
            public void AppendPropertyValue(object value) {
                object existingValue;
                // TODO Might not be a textual conversion
                if (pendingMetadata.TryGetValue(PropertyAttribute.Value, out existingValue)) {
                    value = string.Concat(existingValue, value);
                }
