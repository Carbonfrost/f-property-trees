...
namespace Carbonfrost.Commons.PropertyTrees {
    ...
    static class PropertyTreesFailure {
        ...
        public static NotSupportedException CannotConvertToString() {
            return Failure.Prepare(new NotSupportedException(SR.CannotConvertToString()));
        }

        public static NotSupportedException CannotConvertFromString(Type destinationType) {
            return Failure.Prepare(new NotSupportedException(SR.CannotConvertFromString(destinationType)));
        }
    }
